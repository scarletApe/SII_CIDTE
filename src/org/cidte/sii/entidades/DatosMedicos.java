...
public class DatosMedicos {
	...
	public String toString() {
		return "DatosMedicos{" + "id=" + id + ", curp=" + curp + ", numero_ss=" + numero_ss + ", tipo_sangre="
				+ tipo_sangre + ", peso=" + peso + ", lentes=" + lentes + ", alergias=" + alergias + ", discapacidades="
				+ discapacidades + ", tratamiento_vida=" + tratamiento_vida + '}';
	}
