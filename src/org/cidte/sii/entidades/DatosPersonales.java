...
public class DatosPersonales {
	...
	public String toString() {
		return "DatosPersonales{" + "id=" + id + ", curp=" + curp + ", religion=" + religion + ", estado_civil="
				+ estado_civil + ", talla_altura=" + talla_altura + ", talla_cintura=" + talla_cintura
				+ ", talla_cuello=" + talla_cuello + ", talla_calzado=" + talla_calzado + '}';
	}
