...
public class Permiso implements Serializable {
    ...
    public Permiso(String curp, String motivo_solicitud, Date fecha_solicitud, boolean autorizado, Date fecha_autorizacion, int id_documentopdf) {
        this.curp = curp;
    ...
    public String toString() {
        return "Permiso{" + "id_permiso=" + id_permiso + ", curp=" + curp
                + ", motivo_solicitud=" + motivo_solicitud + ", fecha_solicitud="
                + fecha_solicitud + ", autorizado=" + autorizado + ", fecha_autorizacion="
                + fecha_autorizacion + '}';
    }
