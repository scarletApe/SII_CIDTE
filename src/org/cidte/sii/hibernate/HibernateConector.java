	...
	static {
		try {
			...
			// addPackage("com.xyz") //add package if used.
					addAnnotatedClass(TipoContratacion.class).addAnnotatedClass(Nomina.class)
					.addAnnotatedClass(Permiso.class).addAnnotatedClass(DocumentoPDF.class).buildSessionFactory();
		} catch (Throwable ex) {
			// Log the exception.
