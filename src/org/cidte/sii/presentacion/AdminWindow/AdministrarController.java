...
public class AdministrarController implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		ObservableList<String> opciones = FXCollections.observableArrayList(msg.getString("usuarios"),
	...
	private void loadAllPanes() {
		try {
			...
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/org/cidte/sii/presentacion/AdminWindow/Usuarios.fxml"));
			usuariosPane = (AnchorPane) loader.load();
//			usuariosController = loader.<UsuariosController> getController();

			loader = new FXMLLoader(
					getClass().getResource("/org/cidte/sii/presentacion/AdminWindow/Personalizacion.fxml"));
...
//			personalizacionController = loader.<PersonalizacionController> getController();
	...
	public void setPane(AnchorPane p) {
		// System.out.println("p_width=" + p.getWidth() + " p_height=" +
		// p.getHeight());
		p.setPrefSize(paneData.getWidth(), paneData.getHeight());
		p.setMinSize(paneData.getWidth(), paneData.getHeight());
		// System.out.println("pd_width=" + paneData.getWidth() + " pd_height="
		// + paneData.getHeight());
		// System.out.println("p_width=" + p.getWidth() + " p_height=" +
		// p.getHeight());
