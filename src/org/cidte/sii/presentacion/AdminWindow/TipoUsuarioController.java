...
//		colID.setCellValueFactory(new PropertyValueFactory<>("id_tipousario"));
//
...
//		tableTU.getColumns().addAll(colID, colNombre, colDescripcion, colRol);
//	}
	...
	private void fillTable() {
		...
		ObservableList<String> rols = FXCollections.observableArrayList("Administrativo", "Operativo");
		cbRol.setItems(rols);
