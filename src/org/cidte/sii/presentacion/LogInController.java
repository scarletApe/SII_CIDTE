...
//                setTextFill(Color.WHITE);
    ...
    void handleButtonEntrar(ActionEvent event) {
        ...
        if (rol.equalsIgnoreCase("Adm")) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/cidte/sii/presentacion/AdminWindow/Administrar.fxml"));
            ...
            try {
//                Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("org/cidte/sii/presentacion/UserWindow/VentanaPrincipal.fxml"));
...
//                ((Node) (event.getSource())).getScene().getWindow().hide();
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/cidte/sii/presentacion/UserWindow/VentanaPrincipal.fxml"));
...
//                stage.setTitle("Administrator Window");
                ...
                stage.show();
                controller.initData(usuario, stage); //i switched this to activate after
