...
public class RH_Tipo_ContratacionController implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		ObservableList<String> tipo_parti = FXCollections.observableArrayList("Docente", "Trabajador", "Estudiante");
		...
		horas = FXCollections.observableArrayList("Tiempo Completo", "Tiempo Medio", "Horas");
		...
		ObservableList<String> int_ext = FXCollections.observableArrayList("Interno", "Externo");
	...
	private void limpiar() {
		...
		/**
		 * @todo I have no idea what happens right here that it disapears but
		 *       then it doens't allow to reappear.
		 */
